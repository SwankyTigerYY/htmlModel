;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoTextFiltered: '<span class="parameter parameter-warning">查找</span> &nbsp; {0}/{1}', // when not all of the options are visible due to the filter
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.elements = {
        ...
        label1: $('.box1 > parameter', this.container),
        label2: $('.box2 > parameter', this.container),
