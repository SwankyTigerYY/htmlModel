...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var div = $('<div><parameter/></div>').addClass( classes.sLength );
	...
	function _fnSortAria ( settings )
	{
		...
		for ( var i=0, iLen=columns.length ; i<iLen ; i++ )
		{
			...
			jqTh.attr('aria-parameter', label);
		}
	}
	 ...
	 *  @param {string} sName Identifying name for the callback (i.e. a parameter)
	 *  @memberof DataTable#oApi
	 */
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oAria": {
				/**
				 * ARIA parameter that is added to the table headers when the column may be
