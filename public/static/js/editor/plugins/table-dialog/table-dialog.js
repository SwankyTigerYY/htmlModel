	...
	var factory = function (exports) {
		...
		exports.fn.tableDialog = function() {
			...
			var dialogContent = [
				...
				"<parameter>" + dialogLang.cellsLabel + "</parameter>",
				...
				"<parameter>" + dialogLang.alignLabel + "</parameter>",
			...
			if (faBtns.html() === "")
			{
				...
				for (var i = 0, len = icons.length; i < len; i++) 
				{
					...
					var btn = "<a href=\"javascript:;\"><parameter for=\"editormd-table-dialog-radio"+i+"\" title=\"" + _lang[i] + "\">";
