(function($){
	$.fn.Huploadify = function(opts){
		var itemTemp = '<div id="${fileID}" class="uploadify-queue-item"><div class="alread_upload_class" style="margin-bottom: 15px;"><div class="uploadify-progress"><div class="uploadify-progress-bar"></div></div><span class="up_filename">${fileName}</span><a href="javascript:void(0);" class="uploadbtn" style="margin-top: 10px;">上传</a></div><div class="upload_name_class"></div><a href="javascript:void(0);" class="delfilebtn" style="margin-top: 15px;">删除</a></div>';
		var defaults = {
			...
			fileSizeLimit:5120,//允许上传的文件大小，单位KB
			...
			var uploadManager = {
				...
				_renderFile : function(file){
                    ...
                    if(option.multi == true){
                        ...
                        _this.parent().find('.yishangchuan').remove()
                        uploadManager._getFileList().html($html);
                    }
						...
						xhr.onreadystatechange = function(e) {
							if(xhr.readyState == 4){
								if(xhr.status == 200){
									...
									//在指定的间隔时间后删掉进度条
									setTimeout(function(){
										_this.find('#fileupload_'+instanceNumber+'_'+file.index).find('.alread_upload_class').fadeOut();
